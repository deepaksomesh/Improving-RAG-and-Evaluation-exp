        ...
        for i, config_path in enumerate(args.retrieval_configs):
            try:
                ...
                if strategy.strategy_type != 'hybrid':
                    print(f"WARNING: Forcing strategy type from {strategy.strategy_type} to hybrid")
...
with open('d:/Thesis/Baselines/summary-augmented-chunking/benchmarks/legalbenchrag/run_benchmark_mini_clustered_centroid_hybrid.py', 'w', encoding='utf-8') as f:
