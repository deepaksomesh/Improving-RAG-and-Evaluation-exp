...
dest_path = 'benchmarks/legalbenchrag/run_benchmark_mini_docname.py'

with open(source_path, 'r', encoding='utf-8') as f:
    content = f.read()

# We need to inject the DocName patch
docname_patch = """
import os
...
# Make sure it logs its results to a different folder so they don't get mixed up if running simultaneously or for easy finding
content = content.replace('results/legalbenchrag', 'results/legalbenchrag_docname')
