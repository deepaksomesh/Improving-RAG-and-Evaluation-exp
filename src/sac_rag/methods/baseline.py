...
class BaselineRetrievalMethod(RetrievalMethod):
    ...
    def __init__(self, retrieval_strategy: BaselineRetrievalStrategy, cache_dir: str | Path | None = None, db_name: str | None = None):
        ...
        if db_name:
            self.sqlite_db_file_path = self.cache_dir / f"{db_name}_vec.db"
        else:
