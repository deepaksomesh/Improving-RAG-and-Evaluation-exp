...
# Add imports needed for DocNameBaselineRetrievalMethod
...
async def run_strategy(
    ...
    async def run_query(qa_gt: QAGroundTruth) -> Tuple[QAGroundTruth, List[RetrievedSnippet]]:
        async with query_semaphore:
            try:
                # Pure Docname query, no Legal HyDE
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--results-dir", type=str, default="./results/legalbenchrag_docname_baseline",
